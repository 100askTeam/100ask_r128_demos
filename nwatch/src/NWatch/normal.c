...
static display_t draw()
{
	...
	if(!appConfig.showFPS)
	{
		...
		sprintf((char *)temp,"%d%%", dht11_data_t->hum);//ʪ��
...
static display_t ticker()
{
	...
	if(milliseconds%3600>1800)   // ��װ�ǰ�����  30ms
