...
#define LCD_OLED_IIC_PORT   CONFIG_USE_100ASK_MODULE_DRIVER_IIC_OLED_PORT
#define LCD_OLED_IIC_ADDR   CONFIG_USE_100ASK_MODULE_DRIVER_IIC_OLED_ADDR
...
void LCD_Init(void)
{
  OLED_Init(LCD_OLED_IIC_PORT, LCD_OLED_IIC_ADDR);
}
...
FINSH_FUNCTION_EXPORT_CMD(LCD_Test, test_100ask_iic_oled, module driver 100ask test iic oled);
